...
public class Packet implements Serializable {
    ...
    public enum PacketPropose {
        SIGN_UP_REQUEST, LOGIN_REQUEST, LOGOUT_REQUEST, SERVER_RESPOND_TO_LOGIN, SERVER_RESPOND_TO_SIGNUP, PROFILE_INFO, PROFILES_IN_SYSTEM, PLAY_TOGETHER_REQUEST, RESPOND_PLAY_TOGETHER, ADD_FRIEND_REQUEST, RESPOND_ADD_FRIEND, CANCEL_TOGETHER_REQUEST, UPDATE_GAME, START_GAME, CHAT, RECOVER_PASSWORD_REQUEST, SERVER_RESPOND_TO_RECOVER_PASS;
