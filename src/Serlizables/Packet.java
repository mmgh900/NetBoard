...
public class Packet implements Serializable {
    ...
    public enum PacketPropose {
        LOAD_PACKET, MASSAGE, LOGIN_REQUEST, LOGOUT_REQUEST, PROFILES_IN_SYSTEM, PROFILE_INFO, RECOVER_PASSWORD_REQUEST, RESPOND_ADD_FRIEND, RESPOND_PLAY_TOGETHER, SERVER_ERROR_IN_LOGIN, SERVER_RESPOND_TO_RECOVER_PASS, SERVER_RESPOND_TO_SIGNUP, SIGN_UP_REQUEST, START_GAME, UPDATE_GAME;
