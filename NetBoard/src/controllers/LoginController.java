...
public class LoginController extends StandardController implements Initializable {
    ...
    EventHandler<MouseEvent> signUp = new EventHandler<>() {
        public void handle(MouseEvent event) {
            ...
            client.socketStreamManager.sendPacket(new Packet(client.getClientProfile(), client, Packet.PacketPropose.SIGN_UP_REQUEST));
        }
    };
    EventHandler<MouseEvent> login = new EventHandler<>() {
        public void handle(MouseEvent event) {
            ...
            client.socketStreamManager.sendPacket(new Packet(client.getClientProfile(), client, Packet.PacketPropose.LOGIN_REQUEST));
        }
    };
    EventHandler<MouseEvent> recover = new EventHandler<>() {
        public void handle(MouseEvent event) {
            ...
            client.socketStreamManager.sendPacket(new Packet(client.getClientProfile(), client, Packet.PacketPropose.RECOVER_PASSWORD_REQUEST));
        }
    };
